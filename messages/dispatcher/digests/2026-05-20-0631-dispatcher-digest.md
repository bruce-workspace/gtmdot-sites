# GTMDot Dispatcher Digest - 2026-05-20T06:31:01-04:00

Mode: B1.0 dry-run only
Authority: Git/message files + Paperclip are canonical; Slack/Telegram are notification mirrors.

## Executive State
- Paperclip health: ok (from cache; direct Python localhost read blocked)
- Paperclip read source: api+cache
...
- outreach / unknown: Decide whether to approve copy/template code changes after audit, if changes are recommended.
- outreach / unknown: Decide whether updated copy should apply to manual preview sends only first, or also automated follow-ups once reply monitoring is considered safe enough.
- outreach / unknown: Inspect active template code, render sample emails, produce a copy audit with recommended first-name personalization and sequence-level improvements, then wait for approval before production send/deploy.
- outreach / unknown: Any production send, CRM write, deploy, or automated follow-up resumption still requires separate approval.

## Lane Status
### Quarterback / Main GTMDot
- Status file: `/Users/bruce/.openclaw/workspace/gtmdot-sites/messages/status/quarterback-latest.md`
- Updated: 2026-05-18T12:36:39-04:00 WARNING: stale status file (41.9h old).
...
- Updated: 2026-05-17T18:49:19Z WARNING: stale status file (63.7h old).
...
- Updated: 2026-05-18T06:55:00-04:00 WARNING: stale status file (47.6h old).
...
- Updated: 2026-05-18T12:33:32-04:00 WARNING: stale status file (42.0h old).
...
- Blockers: - None yet for read-only audit. - Any production send, CRM write, deploy, or automated follow-up resumption still requires separate approval.
- Decisions: - Decide whether to approve copy/template code changes after audit, if changes are recommended. - Decide whether updated copy should apply to manual preview sends only first, or also automated follow-ups once reply monitoring is considered safe enough.
- Next action: Inspect active template code, render sample emails, produce a copy audit with recommended first-name personalization and sequence-level improvements, then wait for approval before production send/deploy.

### GTMDot Platform / CRM v2
- Status file: `/Users/bruce/.openclaw/workspace/gtmdot-sites/messages/status/gtmdot-platform-latest.md`
- Updated: 2026-05-17T08:30:24-04:00 WARNING: stale status file (70.0h old).
...
- Updated: 2026-05-16T02:18:43Z WARNING: stale status file (104.2h old).
- Paperclip IDs: none detected
...
## Recent Artifacts
- `2026-05-18T23-38-00-bruce-status-no-work-this-run.md` (no GTM ID, 2026-05-19T02:38:54-04:00): No pending `collect-request.md` files were found in `~/.openclaw/workspace/gtmdot-sites/sites/*/` after pulling the latest changes. No scraping work was performed in this run.
- `20260519015842-bruce-status-no-work-this-run.md` (no GTM ID, 2026-05-18T21:59:15-04:00): No pending collect-request.md files were found in this run.

## Paperclip Health
- API base: http://127.0.0.1:3199
- Read source: api+cache
- Health: ok (from cache; direct Python localhost read blocked)
...
- Latest backup: `/Users/bruce/.openclaw/workspace/paperclip-sandbox-home/instances/gtmdot-sandbox/data/backups/paperclip-20260518-133327.sql.gz` (60737 bytes, 40.96h old). WARNING: backup older than threshold.
