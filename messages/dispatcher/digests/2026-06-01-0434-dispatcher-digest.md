# GTMDot Dispatcher Digest - 2026-06-01T04:34:01-07:00
...
- Updated: 2026-06-01T11:25:00-04:00
- Paperclip IDs: GTM-1, GTM-4, GTM-6, GTM-9, GTM-15, GTM-16, GTM-17, GTM-18, GTM-19, GTM-20, GTM-22, GTM-23, GTM-24
- Summary: Dispatcher B1.0 generated a dry-run digest at `/Users/bruce/.openclaw/workspace/gtmdot-sites/messages/dispatcher/digests/2026-06-01-0234-dispatcher-digest.md`. Codex then completed the approved Poplar provider-state production fix and exception reconciliation documented in `/Users/bruce/.openclaw/workspace/gtmdot-si... Use the dispatcher digest approval queue and lane outbox files to route the next board-clearing action without manual re-summarization.
- Blockers: - Pre-Build Coordination: stale status file (206.5h old) - GTMDot Platform / CRM v2: stale status file (209.3h old) - Experiments: stale status file (206.3h old) - `24-hrs-mobile-tire-services`, `atlanta-drywall-1`, and `perez-pools-llc` remain Poplar provider `exception`; CRM now correctly derives all three as `postcardStatus: suppressed`.
...
- Updated: 2026-05-23T15:06:59-04:00 WARNING: stale status file (208.5h old).
...
- Updated: 2026-05-23T15:17:28-04:00 WARNING: stale status file (208.3h old).
- Paperclip IDs: none detected
...
## Recent Artifacts
- `2026-06-01-crm-review-workflow-ux-deploy-complete.md` (no GTM ID, 2026-06-01T04:23:18-07:00): CRM Review Workflow UX Deploy Complete
- `2026-06-01-1119-bruce-status-no-work-this-run.md` (no GTM ID, 2026-06-01T04:19:43-07:00): subject: no work this run
- `2026-06-01-crm-v2-codex-takeover-control-plane-reset.md` (no GTM ID, 2026-06-01T03:47:48-07:00): CRM v2 Codex Takeover / Control-Plane Reset
- `2026-06-01-crm-review-ux-and-current-board-friction.md` (no GTM ID, 2026-06-01T03:46:34-07:00): CRM Review UX And Current Board Friction
- `2026-06-01-poplar-provider-state-production-fix-complete.md` (no GTM ID, 2026-06-01T03:39:30-07:00): Poplar Provider-State Production Fix Complete
- `2026-06-01-poplar-provider-truth-audit.md` (no GTM ID, 2026-06-01T03:33:50-07:00): Poplar Provider Truth Audit
- `2026-06-01-0259-bruce-status-no-work-this-run.md` (no GTM ID, 2026-05-31T19:59:37-07:00): No pending collect-request.md files found this run. All existing requests are archived.
- `2026-05-31-poplar-provider-state-integration-fix.md` (no GTM ID, 2026-05-31T13:41:17-07:00): Poplar Provider-State Integration Fix
- `2026-05-31-24hrs-postcard-exception-ui-diagnosis.md` (no GTM ID, 2026-05-31T13:28:52-07:00): 24 Hrs Mobile Tire Services Postcard Exception / UI Diagnosis - 2026-05-31
- `2026-05-31-dead-enrichment-comment-routing-audit.md` (no GTM ID, 2026-05-31T13:26:57-07:00): Dead / Enrichment / Comment Routing Audit - 2026-05-31
- `2026-05-31-next-catchup-approval-packet.md` (no GTM ID, 2026-05-31T13:19:14-07:00): Next Catch-Up Approval Packet - 2026-05-31
- `2026-05-31-post-vacation-outreach-catchup.md` (no GTM ID, 2026-05-31T13:17:55-07:00): Post-Vacation Outreach Catch-Up - 2026-05-31
- `2026-05-31-return-from-vacation-codex-audit.md` (no GTM ID, 2026-05-31T13:11:52-07:00): GTMDot Return-From-Vacation Audit - 2026-05-31

## Paperclip Health
- API base: http://127.0.0.1:3199
- Read source: api
- Health: ok
- Latest backup: `/Users/bruce/.openclaw/workspace/paperclip-sandbox-home/instances/gtmdot-sandbox/data/backups/paperclip-20260601-033401.sql.gz` (107940 bytes, 1.00h old).
