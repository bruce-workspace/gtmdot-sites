# GTMDot Dispatcher Digest - 2026-05-21T07:50:17-04:00
...
- Updated: 2026-05-20T06:31:01-04:00 WARNING: stale status file (25.3h old).
...
- Summary: Dispatcher B1.0 generated a dry-run digest at `/Users/bruce/.openclaw/workspace/gtmdot-sites/messages/dispatcher/digests/2026-05-20-0631-dispatcher-digest.md`. No Paperclip, CRM, deploy, send, contact, git, or production mutations were performed. Use the dispatcher digest approval queue and lane outbox files to route the next board-clearing action without manual re-summarization.
- Blockers: - Quarterback / Main GTMDot: stale status file (41.9h old) - Pre-Build Coordination: stale status file (63.7h old) - Post-Build Operations: stale status file (47.6h old) - Outreach Operations: stale status file (42.0h old) - GTMDot Platform / CRM v2: stale status file (70.0h old) - Experiments: stale status file (104.2h old)
...
- Updated: 2026-05-17T18:49:19Z WARNING: stale status file (89.0h old).
...
- Updated: 2026-05-18T06:55:00-04:00 WARNING: stale status file (72.9h old).
...
- Next action: Patch active template/send paths, render sample output for owner present/missing and insight present/missing cases, and report exact changes. Do not send or deploy.

### GTMDot Platform / CRM v2
- Status file: `/Users/bruce/.openclaw/workspace/gtmdot-sites/messages/status/gtmdot-platform-latest.md`
- Updated: 2026-05-17T08:30:24-04:00 WARNING: stale status file (95.3h old).
...
- Updated: 2026-05-16T02:18:43Z WARNING: stale status file (129.5h old).
- Paperclip IDs: none detected
...
## Recent Artifacts
- `2026-05-21-poplar-recipient-name-rule.md` (no GTM ID, 2026-05-21T06:41:08-04:00): Poplar recipient name rule
- `2026-05-20-bruce-status-no-work-this-run.md` (no GTM ID, 2026-05-20T07:21:47-04:00): No pending collect-request.md files found in gtmdot-sites/sites/*/ at 2026-05-20 04:21 AM (America/Los_Angeles). No scraping initiated this run.
...
- Latest backup: `/Users/bruce/.openclaw/workspace/paperclip-sandbox-home/instances/gtmdot-sandbox/data/backups/paperclip-20260521-074142.sql.gz` (66976 bytes, 0.14h old).
