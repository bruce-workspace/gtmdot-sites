# GTMDot Dispatcher Digest - 2026-05-22T10:31:51-07:00
...
- Updated: 2026-05-22T10:16:51-07:00
...
- Summary: Dispatcher B1.0 generated a dry-run digest at `/Users/bruce/.openclaw/workspace/gtmdot-sites/messages/dispatcher/digests/2026-05-22-1016-dispatcher-digest.md`. No Paperclip, CRM, deploy, send, contact, git, or production mutations were performed. Use the dispatcher digest approval queue and lane outbox files to route the next board-clearing action without manual re-summarization.
- Blockers: - Pre-Build Coordination: stale status file (118.5h old) - Post-Build Operations: stale status file (102.4h old) - GTMDot Platform / CRM v2: stale status file (124.8h old) - Experiments: stale status file (159.0h old)
...
- Updated: 2026-05-17T18:49:19Z WARNING: stale status file (118.7h old).
...
- Updated: 2026-05-18T06:55:00-04:00 WARNING: stale status file (102.6h old).
...
- Updated: 2026-05-22T06:47:58-04:00
- Paperclip IDs: GTM-12
- Summary: - Harrison detail API shows no postcard outreach events and `postcardStatus: "not_submitted"`. - The list API bug that treated `approvedFor: ["postcard"]` as `submitted` has been fixed locally. - Local CRM now exposes a no-send `preview_postcard_payload` action for payload inspection before Poplar submission. - Harr... Refresh the CRM page and retry Harrison's postcard only if Jesse wants to spend that attempt now. If it fails, stop and pull `/private/tmp/gtmdot-crm.log` so the captured Poplar body can become the next remediation artifact.
- Blockers: - No resend attempt has been made after the local remediation. - If Poplar still rejects Harrison, the now-added sanitized provider error log should capture status/body/recipient details. - Browser page should be refreshed before retrying so it uses the restarted CRM server/current bundle.
- Next action: Refresh the CRM page and retry Harrison's postcard only if Jesse wants to spend that attempt now. If it fails, stop and pull `/private/tmp/gtmdot-crm.log` so the captured Poplar body can become the next remediation artifact.

### GTMDot Platform / CRM v2
- Status file: `/Users/bruce/.openclaw/workspace/gtmdot-sites/messages/status/gtmdot-platform-latest.md`
- Updated: 2026-05-17T08:30:24-04:00 WARNING: stale status file (125.0h old).
...
- Updated: 2026-05-16T02:18:43Z WARNING: stale status file (159.2h old).
...
- Read source: api
- Health: ok
- Latest backup: `/Users/bruce/.openclaw/workspace/paperclip-sandbox-home/instances/gtmdot-sandbox/data/backups/paperclip-20260522-103014.sql.gz` (75534 bytes, 0.03h old).
