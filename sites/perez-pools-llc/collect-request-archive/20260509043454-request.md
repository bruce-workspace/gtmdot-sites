...
# Collect-request — perez-pools-llc (postcard hero regen via gpt-image-2)
...
- **Save to:** `sites/perez-pools-llc/photos-generated/hero-postcard.jpg`
...
Crystal-clear pool with skimmer running, premium tile on right edge.
...
1. New file at `sites/perez-pools-llc/photos-generated/hero-postcard.jpg` (3360×1872 JPEG)
2. Updated `sites/perez-pools-llc/bruce-asset-intel.json` with new `generated_images[]`
...
3. Append to `sites/perez-pools-llc/bruce-asset-intel.md` a "## Postcard Hero v3 —
   gpt-image-2" section noting the regen.
4. Commit + push.

Mini's downstream: pulls main, copies to `gtmdot/postcards/perez-pools-llc-hero.jpg`,
...
- Routing returns MiniMax / DALL-E / Recraft instead of gpt-image-2 → write
  `messages/<date>-bruce-blocked-image-routing-perez-pools-llc.md` and stop.
