...
requested_at: 2026-04-28T03:49:58.777870+00:00
requested_by: mini-enrichment-dispatcher
---

# Collect Request — thermys-mobile-tire-and-brakes
...
## Gap reason
photos: 0 of target 3

## Current capture state
- Photos in `sites/thermys-mobile-tire-and-brakes/photos/`: **0** (target: 3)
- Reviews captured (`reviews.json.counts.captured`): **5** (target: 3)
