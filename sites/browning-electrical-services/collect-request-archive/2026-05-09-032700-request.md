...
# Collect-request — browning-electrical-services (postcard hero regen via gpt-image-2)
...
- **Save to:** `sites/browning-electrical-services/photos-generated/hero-postcard.jpg`
...
Electrical service panel close-up with new breakers, clean professional installation, residential basement setting on right.
...
1. New file at `sites/browning-electrical-services/photos-generated/hero-postcard.jpg` (3360×1872 JPEG)
2. Updated `sites/browning-electrical-services/bruce-asset-intel.json` with new `generated_images[]`
...
3. Append to `sites/browning-electrical-services/bruce-asset-intel.md` a "## Postcard Hero v3 —
   gpt-image-2" section noting the regen.
4. Commit + push.

Mini's downstream: pulls main, copies to `gtmdot/postcards/browning-electrical-services-hero.jpg`,
...
- Routing returns MiniMax / DALL-E / Recraft instead of gpt-image-2 → write
  `messages/<date>-bruce-blocked-image-routing-browning-electrical-services.md` and stop.
