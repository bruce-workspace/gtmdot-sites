...
# Collect-request — professional-gutter-cleaning (postcard hero regen via gpt-image-2)
...
- **Save to:** `sites/professional-gutter-cleaning/photos-generated/hero-postcard.jpg`
...
Pristine gutters along Atlanta home exterior, fresh foliage, ladder against right side.
...
1. New file at `sites/professional-gutter-cleaning/photos-generated/hero-postcard.jpg` (3360×1872 JPEG)
2. Updated `sites/professional-gutter-cleaning/bruce-asset-intel.json` with new `generated_images[]`
...
3. Append to `sites/professional-gutter-cleaning/bruce-asset-intel.md` a "## Postcard Hero v3 —
   gpt-image-2" section noting the regen.
4. Commit + push.

Mini's downstream: pulls main, copies to `gtmdot/postcards/professional-gutter-cleaning-hero.jpg`,
...
- Routing returns MiniMax / DALL-E / Recraft instead of gpt-image-2 → write
  `messages/<date>-bruce-blocked-image-routing-professional-gutter-cleaning.md` and stop.
