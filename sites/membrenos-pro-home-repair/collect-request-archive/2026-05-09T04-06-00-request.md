...
# Collect-request — membrenos-pro-home-repair (postcard hero regen via gpt-image-2)
...
- **Save to:** `sites/membrenos-pro-home-repair/photos-generated/hero-postcard.jpg`
...
Home renovation project mid-stage, clean tools on right, warm interior light.
...
1. New file at `sites/membrenos-pro-home-repair/photos-generated/hero-postcard.jpg` (3360×1872 JPEG)
2. Updated `sites/membrenos-pro-home-repair/bruce-asset-intel.json` with new `generated_images[]`
...
3. Append to `sites/membrenos-pro-home-repair/bruce-asset-intel.md` a "## Postcard Hero v3 —
   gpt-image-2" section noting the regen.
4. Commit + push.

Mini's downstream: pulls main, copies to `gtmdot/postcards/membrenos-pro-home-repair-hero.jpg`,
...
- Routing returns MiniMax / DALL-E / Recraft instead of gpt-image-2 → write
  `messages/<date>-bruce-blocked-image-routing-membrenos-pro-home-repair.md` and stop.
