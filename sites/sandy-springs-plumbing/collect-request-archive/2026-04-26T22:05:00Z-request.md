...
requested_at: 2026-04-25T18:14:24.684346+00:00
requested_by: mini-enrichment-dispatcher
---

# Collect Request — sandy-springs-plumbing
...
- Photos in `sites/sandy-springs-plumbing/photos/`: **0** (target: 3)
- Reviews captured (`reviews.json.counts.captured`): **4** (target: 3)
