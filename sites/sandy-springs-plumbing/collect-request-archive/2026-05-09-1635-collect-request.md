...
# Collect-request — sandy-springs-plumbing (postcard hero regen via gpt-image-2)
...
- **Save to:** `sites/sandy-springs-plumbing/photos-generated/hero-postcard.jpg`
...
Premium kitchen plumbing under sink, copper detail on right, warm cabinet interior. (Currently has gpt-image-2 hero at 1536x1024 — re-generate at 3360x1872.)
...
1. New file at `sites/sandy-springs-plumbing/photos-generated/hero-postcard.jpg` (3360×1872 JPEG)
2. Updated `sites/sandy-springs-plumbing/bruce-asset-intel.json` with new `generated_images[]`
...
3. Append to `sites/sandy-springs-plumbing/bruce-asset-intel.md` a "## Postcard Hero v3 —
   gpt-image-2" section noting the regen.
4. Commit + push.

Mini's downstream: pulls main, copies to `gtmdot/postcards/sandy-springs-plumbing-hero.jpg`,
...
- Routing returns MiniMax / DALL-E / Recraft instead of gpt-image-2 → write
  `messages/<date>-bruce-blocked-image-routing-sandy-springs-plumbing.md` and stop.
