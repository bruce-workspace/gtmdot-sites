...
# Collect-request — pro-gutter-cleaning (postcard hero regen via gpt-image-2)
...
- **Save to:** `sites/pro-gutter-cleaning/photos-generated/hero-postcard.jpg`
...
Atlanta home exterior with clean gutters, fresh blue sky, ladder on right side near eaves.
...
1. New file at `sites/pro-gutter-cleaning/photos-generated/hero-postcard.jpg` (3360×1872 JPEG)
2. Updated `sites/pro-gutter-cleaning/bruce-asset-intel.json` with new `generated_images[]`
...
3. Append to `sites/pro-gutter-cleaning/bruce-asset-intel.md` a "## Postcard Hero v3 —
   gpt-image-2" section noting the regen.
4. Commit + push.

Mini's downstream: pulls main, copies to `gtmdot/postcards/pro-gutter-cleaning-hero.jpg`,
...
- Routing returns MiniMax / DALL-E / Recraft instead of gpt-image-2 → write
  `messages/<date>-bruce-blocked-image-routing-pro-gutter-cleaning.md` and stop.
