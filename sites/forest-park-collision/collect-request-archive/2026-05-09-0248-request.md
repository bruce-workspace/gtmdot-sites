...
# Collect-request — forest-park-collision (postcard hero regen via gpt-image-2)
...
- **Save to:** `sites/forest-park-collision/photos-generated/hero-postcard.jpg`
...
Polished sedan inside a clean modern body shop under soft overhead lights, paint-booth atmosphere, vehicle on right.
...
1. New file at `sites/forest-park-collision/photos-generated/hero-postcard.jpg` (3360×1872 JPEG)
2. Updated `sites/forest-park-collision/bruce-asset-intel.json` with new `generated_images[]`
...
3. Append to `sites/forest-park-collision/bruce-asset-intel.md` a "## Postcard Hero v3 —
   gpt-image-2" section noting the regen.
4. Commit + push.

Mini's downstream: pulls main, copies to `gtmdot/postcards/forest-park-collision-hero.jpg`,
...
- Routing returns MiniMax / DALL-E / Recraft instead of gpt-image-2 → write
  `messages/<date>-bruce-blocked-image-routing-forest-park-collision.md` and stop.
