...
requested_at: 2026-04-25T18:14:24.681590+00:00
requested_by: mini-enrichment-dispatcher
---

# Collect Request — doctor-concrete-atl
...
- Photos in `sites/doctor-concrete-atl/photos/`: **0** (target: 3)
- Reviews captured (`reviews.json.counts.captured`): **9** (target: 3)
