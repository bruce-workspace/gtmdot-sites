...
# Collect-request — tuckers-home-services (postcard hero regen via gpt-image-2)
...
- **Save to:** `sites/tuckers-home-services/photos-generated/hero-postcard.jpg`
...
Multi-trade service tools and a service van, organized layout on right side.
...
1. New file at `sites/tuckers-home-services/photos-generated/hero-postcard.jpg` (3360×1872 JPEG)
2. Updated `sites/tuckers-home-services/bruce-asset-intel.json` with new `generated_images[]`
...
3. Append to `sites/tuckers-home-services/bruce-asset-intel.md` a "## Postcard Hero v3 —
   gpt-image-2" section noting the regen.
4. Commit + push.

Mini's downstream: pulls main, copies to `gtmdot/postcards/tuckers-home-services-hero.jpg`,
...
- Routing returns MiniMax / DALL-E / Recraft instead of gpt-image-2 → write
  `messages/<date>-bruce-blocked-image-routing-tuckers-home-services.md` and stop.
