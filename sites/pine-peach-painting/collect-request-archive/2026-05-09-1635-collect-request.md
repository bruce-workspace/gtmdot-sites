...
# Collect-request — pine-peach-painting (postcard hero regen via gpt-image-2)
...
- **Save to:** `sites/pine-peach-painting/photos-generated/hero-postcard.jpg`
...
Freshly painted suburban home exterior, warm Georgia afternoon light, pristine paint finish on porch column right.
...
1. New file at `sites/pine-peach-painting/photos-generated/hero-postcard.jpg` (3360×1872 JPEG)
2. Updated `sites/pine-peach-painting/bruce-asset-intel.json` with new `generated_images[]`
...
3. Append to `sites/pine-peach-painting/bruce-asset-intel.md` a "## Postcard Hero v3 —
   gpt-image-2" section noting the regen.
4. Commit + push.

Mini's downstream: pulls main, copies to `gtmdot/postcards/pine-peach-painting-hero.jpg`,
...
- Routing returns MiniMax / DALL-E / Recraft instead of gpt-image-2 → write
  `messages/<date>-bruce-blocked-image-routing-pine-peach-painting.md` and stop.
