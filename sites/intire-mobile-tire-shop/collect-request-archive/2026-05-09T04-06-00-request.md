...
# Collect-request — intire-mobile-tire-shop (postcard hero regen via gpt-image-2)
...
- **Save to:** `sites/intire-mobile-tire-shop/photos-generated/hero-postcard.jpg`
...
Mobile tire service van, tire being mounted on right, residential driveway.
...
1. New file at `sites/intire-mobile-tire-shop/photos-generated/hero-postcard.jpg` (3360×1872 JPEG)
2. Updated `sites/intire-mobile-tire-shop/bruce-asset-intel.json` with new `generated_images[]`
...
3. Append to `sites/intire-mobile-tire-shop/bruce-asset-intel.md` a "## Postcard Hero v3 —
   gpt-image-2" section noting the regen.
4. Commit + push.

Mini's downstream: pulls main, copies to `gtmdot/postcards/intire-mobile-tire-shop-hero.jpg`,
...
- Routing returns MiniMax / DALL-E / Recraft instead of gpt-image-2 → write
  `messages/<date>-bruce-blocked-image-routing-intire-mobile-tire-shop.md` and stop.
