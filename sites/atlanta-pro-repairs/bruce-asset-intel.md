...
generated_at: 2026-05-09T03:11:00Z
status: success
collect_request_ref: sites/atlanta-pro-repairs/collect-request.md
---

# Bruce Asset Intelligence — Atlanta Pro Repairs

## Postcard Hero v3 — gpt-image-2

**Status:** SUCCESS
**Generated:** 2026-05-09T03:11:00Z
...
**Prompt used:**
> Home repair workshop with tools organized on pegboard walls, project on workbench on right side. Horizontal composition with primary visual subject on the right two-thirds of the frame. Left third may go dark or be visually quieter — overlaid with text and gradient. No text, no readable signage, no logos, no license plates, no identifiable people. Cinematic photorealistic style, warm professional lighting, premium editorial feel. 16:9 horizontal landscape orientation.
