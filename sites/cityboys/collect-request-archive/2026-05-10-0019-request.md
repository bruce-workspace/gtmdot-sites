...
# Collect-request — cityboys (postcard hero regen via gpt-image-2)
...
- **Save to:** `sites/cityboys/photos-generated/hero-postcard.jpg`
...
Polished classic vehicle exterior, deep paint reflections, late afternoon light on right side.
...
1. New file at `sites/cityboys/photos-generated/hero-postcard.jpg` (3360×1872 JPEG)
2. Updated `sites/cityboys/bruce-asset-intel.json` with new `generated_images[]`
...
3. Append to `sites/cityboys/bruce-asset-intel.md` a "## Postcard Hero v3 —
   gpt-image-2" section noting the regen.
4. Commit + push.

Mini's downstream: pulls main, copies to `gtmdot/postcards/cityboys-hero.jpg`,
...
- Routing returns MiniMax / DALL-E / Recraft instead of gpt-image-2 → write
  `messages/<date>-bruce-blocked-image-routing-cityboys.md` and stop.
