...
# Collect-request — raiden-electrical (postcard hero regen via gpt-image-2)
...
- **Save to:** `sites/raiden-electrical/photos-generated/hero-postcard.jpg`
...
Modern smart-home electrical setup, warm ambient lighting, EV charger or smart panel on right.
...
1. New file at `sites/raiden-electrical/photos-generated/hero-postcard.jpg` (3360×1872 JPEG)
2. Updated `sites/raiden-electrical/bruce-asset-intel.json` with new `generated_images[]`
...
3. Append to `sites/raiden-electrical/bruce-asset-intel.md` a "## Postcard Hero v3 —
   gpt-image-2" section noting the regen.
4. Commit + push.

Mini's downstream: pulls main, copies to `gtmdot/postcards/raiden-electrical-hero.jpg`,
...
- Routing returns MiniMax / DALL-E / Recraft instead of gpt-image-2 → write
  `messages/<date>-bruce-blocked-image-routing-raiden-electrical.md` and stop.
