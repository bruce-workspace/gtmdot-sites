...
# Collect-request — golden-choice-prowash (postcard hero regen via gpt-image-2)
...
- **Save to:** `sites/golden-choice-prowash/photos-generated/hero-postcard.jpg`
...
High-pressure washing of stone driveway, water arc visible, clean stripe on right.
...
1. New file at `sites/golden-choice-prowash/photos-generated/hero-postcard.jpg` (3360×1872 JPEG)
2. Updated `sites/golden-choice-prowash/bruce-asset-intel.json` with new `generated_images[]`
...
3. Append to `sites/golden-choice-prowash/bruce-asset-intel.md` a "## Postcard Hero v3 —
   gpt-image-2" section noting the regen.
4. Commit + push.

Mini's downstream: pulls main, copies to `gtmdot/postcards/golden-choice-prowash-hero.jpg`,
...
- Routing returns MiniMax / DALL-E / Recraft instead of gpt-image-2 → write
  `messages/<date>-bruce-blocked-image-routing-golden-choice-prowash.md` and stop.
