...
# Collect-request — plumbingpro-north-atlanta (postcard hero regen via gpt-image-2)
...
- **Save to:** `sites/plumbingpro-north-atlanta/photos-generated/hero-postcard.jpg`
...
High-end bathroom fixture installation, polished chrome detail on right, warm marble surfaces.
...
1. New file at `sites/plumbingpro-north-atlanta/photos-generated/hero-postcard.jpg` (3360×1872 JPEG)
2. Updated `sites/plumbingpro-north-atlanta/bruce-asset-intel.json` with new `generated_images[]`
...
3. Append to `sites/plumbingpro-north-atlanta/bruce-asset-intel.md` a "## Postcard Hero v3 —
   gpt-image-2" section noting the regen.
4. Commit + push.

Mini's downstream: pulls main, copies to `gtmdot/postcards/plumbingpro-north-atlanta-hero.jpg`,
...
- Routing returns MiniMax / DALL-E / Recraft instead of gpt-image-2 → write
  `messages/<date>-bruce-blocked-image-routing-plumbingpro-north-atlanta.md` and stop.
