...
# Collect-request — locksmith-atlanta-pro (postcard hero regen via gpt-image-2)
...
- **Save to:** `sites/locksmith-atlanta-pro/photos-generated/hero-postcard.jpg`
...
Premium deadbolt being installed on modern front door, hands and key on right.
...
1. New file at `sites/locksmith-atlanta-pro/photos-generated/hero-postcard.jpg` (3360×1872 JPEG)
2. Updated `sites/locksmith-atlanta-pro/bruce-asset-intel.json` with new `generated_images[]`
...
3. Append to `sites/locksmith-atlanta-pro/bruce-asset-intel.md` a "## Postcard Hero v3 —
   gpt-image-2" section noting the regen.
4. Commit + push.

Mini's downstream: pulls main, copies to `gtmdot/postcards/locksmith-atlanta-pro-hero.jpg`,
...
- Routing returns MiniMax / DALL-E / Recraft instead of gpt-image-2 → write
  `messages/<date>-bruce-blocked-image-routing-locksmith-atlanta-pro.md` and stop.
