...
# Collect-request — 24-hrs-mobile-tire-services (postcard hero regen via gpt-image-2)
...
- **Save to:** `sites/24-hrs-mobile-tire-services/photos-generated/hero-postcard.jpg`
...
Mobile tire service van parked at residential driveway at golden hour, technician's hands working on tire visible right side, suburban Atlanta neighborhood.
...
1. New file at `sites/24-hrs-mobile-tire-services/photos-generated/hero-postcard.jpg` (3360×1872 JPEG)
2. Updated `sites/24-hrs-mobile-tire-services/bruce-asset-intel.json` with new `generated_images[]`
...
3. Append to `sites/24-hrs-mobile-tire-services/bruce-asset-intel.md` a "## Postcard Hero v3 —
   gpt-image-2" section noting the regen.
4. Commit + push.

Mini's downstream: pulls main, copies to `gtmdot/postcards/24-hrs-mobile-tire-services-hero.jpg`,
...
- Routing returns MiniMax / DALL-E / Recraft instead of gpt-image-2 → write
  `messages/<date>-bruce-blocked-image-routing-24-hrs-mobile-tire-services.md` and stop.
