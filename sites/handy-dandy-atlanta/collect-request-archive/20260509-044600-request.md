...
# Collect-request — handy-dandy-atlanta (postcard hero regen via gpt-image-2)
...
- **Save to:** `sites/handy-dandy-atlanta/photos-generated/hero-postcard.jpg`
...
Handyman tools laid on hardwood, hands assembling something on right side.
...
1. New file at `sites/handy-dandy-atlanta/photos-generated/hero-postcard.jpg` (3360×1872 JPEG)
2. Updated `sites/handy-dandy-atlanta/bruce-asset-intel.json` with new `generated_images[]`
...
3. Append to `sites/handy-dandy-atlanta/bruce-asset-intel.md` a "## Postcard Hero v3 —
   gpt-image-2" section noting the regen.
4. Commit + push.

Mini's downstream: pulls main, copies to `gtmdot/postcards/handy-dandy-atlanta-hero.jpg`,
...
- Routing returns MiniMax / DALL-E / Recraft instead of gpt-image-2 → write
  `messages/<date>-bruce-blocked-image-routing-handy-dandy-atlanta.md` and stop.
