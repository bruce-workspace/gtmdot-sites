...
# Collect-request — trushyne-mobile-detailing (postcard hero regen via gpt-image-2)
...
- **Save to:** `sites/trushyne-mobile-detailing/photos-generated/hero-postcard.jpg`
...
Polished SUV exterior under sunset light, water-beading detail on right side panel.
...
1. New file at `sites/trushyne-mobile-detailing/photos-generated/hero-postcard.jpg` (3360×1872 JPEG)
2. Updated `sites/trushyne-mobile-detailing/bruce-asset-intel.json` with new `generated_images[]`
...
3. Append to `sites/trushyne-mobile-detailing/bruce-asset-intel.md` a "## Postcard Hero v3 —
   gpt-image-2" section noting the regen.
4. Commit + push.

Mini's downstream: pulls main, copies to `gtmdot/postcards/trushyne-mobile-detailing-hero.jpg`,
...
- Routing returns MiniMax / DALL-E / Recraft instead of gpt-image-2 → write
  `messages/<date>-bruce-blocked-image-routing-trushyne-mobile-detailing.md` and stop.
