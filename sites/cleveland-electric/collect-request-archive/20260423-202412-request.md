---
slug: cleveland-electric
requested_at: 2026-04-24T03:14:03.205176+00:00
requested_by: mini-enrichment-dispatcher
---

# Collect Request — cleveland-electric
...
## Gap reason
reviews: reviews.json missing

## Current capture state
- Photos in `sites/cleveland-electric/photos/`: **3** (target: 3)
- Reviews captured (`reviews.json.counts.captured`): **missing** (target: 3)
