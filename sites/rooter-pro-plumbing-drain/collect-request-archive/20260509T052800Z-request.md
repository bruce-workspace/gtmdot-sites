---
slug: rooter-pro-plumbing-drain
requested_by: mini
...
# Collect-request — rooter-pro-plumbing-drain (postcard hero regen via gpt-image-2)
...
- **Save to:** `sites/rooter-pro-plumbing-drain/photos-generated/hero-postcard.jpg`
...
Drain cleaning equipment in clean garage workspace, pipe sections on right, professional industrial feel.
...
1. New file at `sites/rooter-pro-plumbing-drain/photos-generated/hero-postcard.jpg` (3360×1872 JPEG)
2. Updated `sites/rooter-pro-plumbing-drain/bruce-asset-intel.json` with new `generated_images[]`
...
3. Append to `sites/rooter-pro-plumbing-drain/bruce-asset-intel.md` a "## Postcard Hero v3 —
   gpt-image-2" section noting the regen.
4. Commit + push.

Mini's downstream: pulls main, copies to `gtmdot/postcards/rooter-pro-plumbing-drain-hero.jpg`,
...
- Routing returns MiniMax / DALL-E / Recraft instead of gpt-image-2 → write
  `messages/<date>-bruce-blocked-image-routing-rooter-pro-plumbing-drain.md` and stop.
