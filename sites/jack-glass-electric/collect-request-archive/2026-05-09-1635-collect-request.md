...
# Collect-request — jack-glass-electric (postcard hero regen via gpt-image-2)
...
- **Save to:** `sites/jack-glass-electric/photos-generated/hero-postcard.jpg`
...
Modern electrical panel with smart features, wiring detail on right, warm utility room.
...
1. New file at `sites/jack-glass-electric/photos-generated/hero-postcard.jpg` (3360×1872 JPEG)
2. Updated `sites/jack-glass-electric/bruce-asset-intel.json` with new `generated_images[]`
...
3. Append to `sites/jack-glass-electric/bruce-asset-intel.md` a "## Postcard Hero v3 —
   gpt-image-2" section noting the regen.
4. Commit + push.

Mini's downstream: pulls main, copies to `gtmdot/postcards/jack-glass-electric-hero.jpg`,
...
- Routing returns MiniMax / DALL-E / Recraft instead of gpt-image-2 → write
  `messages/<date>-bruce-blocked-image-routing-jack-glass-electric.md` and stop.
