...
# Collect-request — piedmont-tires (postcard hero regen via gpt-image-2)
...
- **Save to:** `sites/piedmont-tires/photos-generated/hero-postcard.jpg`
...
Tire showroom interior with stacked premium tires, warm overhead lighting, sales counter on right.
...
1. New file at `sites/piedmont-tires/photos-generated/hero-postcard.jpg` (3360×1872 JPEG)
2. Updated `sites/piedmont-tires/bruce-asset-intel.json` with new `generated_images[]`
...
3. Append to `sites/piedmont-tires/bruce-asset-intel.md` a "## Postcard Hero v3 —
   gpt-image-2" section noting the regen.
4. Commit + push.

Mini's downstream: pulls main, copies to `gtmdot/postcards/piedmont-tires-hero.jpg`,
...
- Routing returns MiniMax / DALL-E / Recraft instead of gpt-image-2 → write
  `messages/<date>-bruce-blocked-image-routing-piedmont-tires.md` and stop.
